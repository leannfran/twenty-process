...
const Aptitudes = () => {
  ...
  const [maxHeights, setMaxHeights] = useState([100, 100, 100]);
  ...
  <div className="flex flex-col md:pl-4 px-2 mt-10 md:w-1/4">
        ...
        <div className="flex flex-col w-full md:w-3/4">
          <div
            className={`relative transition-all aptitudes flex flex-col items-start pt-9 text-xl text-white font-bold shadow-md rounded-lg md:rounded-l-lg ${
              activeIndex === 1 ? 'transition-max-height transition-all ease-in-out duration-300' : 'h-1/3'
            }`}
          ...
          >
            ...
            {activeIndex === 1 ? (
              <p className="animate-fade animate-once animate-delay-500 text-lg font-light p-5 md:pl-10 md:pr-36">
                En Twenty, nos regimos por un conjunto de valores fundamentales que guían nuestro trabajo diario. Estos
                valores incluyen la calidad, la innovación, la honestidad y el compromiso con la satisfacción del cliente.
                Nos enorgullece cumplir con estos valores en cada proyecto que emprendemos.
              </p>
            ) : null}
          </div>
          ...
          <div
            className={`relative transition-all aptitudes flex flex-col items-start pt-9 text-xl text-white font-bold shadow-md rounded-lg md:rounded-l-lg ${
              activeIndex === 2 ? 'transition-max-height ease-in duration-300' : 'h-1/3'
            }`}
          ...
          >
            ...
            {activeIndex === 2 ? (
              <p className="animate-fade animate-once animate-delay-500 text-lg font-light md:pr-36 p-5 md:pl-10">
                Estamos comprometidos con ofrecer a nuestros clientes productos de alta calidad y servicios excepcionales.
                Nos esforzamos por superar las expectativas y establecer relaciones duraderas basadas en la confianza y la
                satisfacción mutua. Nuestro compromiso es ser el socio de confianza para todas las necesidades de
                merchandising B2B de nuestros clientes.
              </p>
            ) : null}
          </div>
          ...
          <div
            className={`relative transition-all aptitudes flex flex-col items-start pt-9 text-xl bg-opacity-75 text-white font-bold shadow-md rounded-lg md:rounded-l-lg ${
              activeIndex === 3 ? 'transition-max-height ease-in duration-300' : 'h-1/3'
            }`}
          ...
          >
            ...
            {activeIndex === 3 ? (
              <p className="animate-fade animate-once animate-delay-500 text-lg font-light md:pr-20 md:p-5 p-10 md:pl-10">
                Nuestro objetivo principal es ayudar a nuestros clientes a destacarse en su industria a través de
                estrategias de merchandising efectivas. Nos esforzamos por ofrecer soluciones innovadoras y personalizadas
                que impulsen el reconocimiento de marca, aumenten las ventas y fortalezcan la relación con los clientes.
                Trabajamos incansablemente para lograr los objetivos comerciales de nuestros clientes y convertirnos en su
                socio de confianza en el ámbito del merchandising B2B.
              </p>
            ) : null}
          </div>
        </div>
