    ...
    <>
      <div className="flex py-10 justify-between items-center">
        <div className="md:ml-24">
          <h2 className="text-black text-lg font-semibold flex gap-2 items-center py-3 pl-4 lg:pl-0">CATEGORÍAS 
      ...
      <Link href="/store" className="md:hidden text-right text-black text-lg font-light flex items-center justify-end gap-5 mr-2">
        Ver todo en Categorías <FaArrowRight />
      </Link>
    </>
  );
