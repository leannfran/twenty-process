...
const ContactForm = () => {
    ...
    return (
        <>
            <div className="flex flex-col md:flex-row justify-center items-center gap-12 mt-20 md:mt-0 mb-10" id='contacto'>
                <div className="bg-primary p-44 w-2/4 flex flex-col justify-center items-center relative h-full md:mt-5">
                    <div
                    ...
                    <form className='flex mt-5 flex-col gap-8 items-center md:items-start' onSubmit={handleSubmit(sendEmail)}>
                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='flex flex-col'>
                                ...
                                {errors.message && <p role='alert' className='text-red-500 mt-1 text-center'>* {errors.message.message}</p>}
