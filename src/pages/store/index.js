...
const store = () => {
  ...
  return (
    <Layout>
      ...
      <h1 className='text-black text-3xl shadow- py-10'>Conoce todos nuestros <span className='border-b pb-1 border-primary'> productos</span>!</h1>        <section className="flex flex-col 1440px:flex-row w-full">
