  ...
  <div className="flex flex-col md:flex-row p-4 md:p-10 mb-10 items-start">
    <div className="w-full md:w-1/2 gap-10 md:gap-6 flex flex-col text-center md:text-start">
      <h1 className="animate-fade text-gray-800 font-bold text-4xl md:text-7xl">
        <span className="text-primary">MERCHANDISING </span> PERSONALIZADO PARA TU <span className="font-semibold text-primary">EMPRESA</span>
      </h1>
      <p className="text-gray-800">
        Te asesoramos y armamos una propuesta a medida de tu empresa y necesidad, déjanos tus datos o envíanos un whatsapp y nos pondremos en contacto al instante.
      </p>
      <div className="flex md:justify-start justify-center gap-4">
        <a href="#contacto" className="bg-primary text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline">
          Contáctanos
        </a>
        <a target={"_blank"} href="https://twentyproductos.tumerchandising.com/" className="bg-primary text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline"> Ver Precios </a>
      </div>
    </div>
  ...
  <div className="container mx-auto px-6">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg">
        ...
        <p className="text-gray-800 mt-2">De los clientes sienten mayor lealtad hacia una marca cuando reciben productos de merchandising.</p>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg">
        ...
        <p className="text-gray-800 mt-2">De las empresas reportan un aumento en la atracción de visitantes a sus stands cuando utilizan merchandising efectivo.</p>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg">
        ...
        <p className="text-gray-800 mt-2">De las marcas observan un aumento significativo en la recordación de marca cuando integran merchandising en su estrategia de marketing.</p>
      </div>
    </div>
  </div>
</section>
        ...
        >
          <SwiperSlide>
            <div className="flex flex-col md:flex-row items-center md:space-x-8 p-4">
              ...
              <div className="border-primary text-start border p-6 rounded-lg shadow-lg md:flex-1">
                ...
                <p className="mb-4">
                  <strong>Comentarios:</strong> "Que las chicas siempre estuvieron muy atentas en todo lo que necesite, cumplieron con los tiempos de entrega y me ayudaron con las cajas hasta el auto jaja gracias!! Los productos todos de muy buena calidad "
                </p>
          ...
          <SwiperSlide>
            <div className="flex flex-col md:flex-row items-center md:space-x-8 p-4">
              ...
              <div className="border-primary text-start border p-6 rounded-lg shadow-lg md:flex-1">
                <h3 className="text-2xl font-semibold mb-4">Los Pinos Lubricantes SRL</h3>
                <div className="flex items-center mb-4">
                  <strong>Nivel de satisfacción: 5/5 </strong>
                  {/* Inserta aquí los íconos de las estrellas */}
                </div>
                <p className="mb-4">
                  <strong>Comentarios:</strong> "Las mochilas industriales son un excelente producto, y el trabajo en logos es muy prolijo. El asesoramiento de diseño prestando atención a ciertos 'detalles' fue muy valioso."
                </p>
          ...
          <SwiperSlide>
            <div className="flex flex-col md:flex-row items-center md:space-x-8 p-4">
              ...
              <div className="border-primary text-start border p-6 rounded-lg shadow-lg md:flex-1">
                ...
                <p className="mb-4">
                  <strong>Comentarios:</strong> "Muy Buena atencion por WhatsApp"
                </p>
